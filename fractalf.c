...
printf("a edge:  %.10f\t\tb edge:  %.10f\n", aedge, bedge);
printf("x delta: %.10f\t\ty delta: %.10f\n", xdelta, ydelta);
printf("Julia a: %.10f\t\tJulia b: %.10f\n", a, b);
printf("Limit: %d\n", limit);
...
scanf("%s", str);
if (str[0] != 'y') { return; }
printf("Enter a edge (or n to default to %.10f): ", aedge);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &aedge); }
printf("Enter b edge (or n to default to %.10f): ", bedge);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &bedge); }
printf("Enter x delta (or n to default to %.10f): ", xdelta);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &xdelta); }
printf("Enter y delta (or n to default to %.10f): ", ydelta);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &ydelta); }
printf("Enter Julia a (or n to default to %.10f): ", a);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &a); }
printf("Enter Julia b (or n to default to %.10f): ", b);
scanf("%s", str); if (str[0] != 'n') { sscanf(str, "%f", &b); }
